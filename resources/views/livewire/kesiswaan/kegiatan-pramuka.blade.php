    ...
    <section id="kegPramuka" class="portfolio">
        <div class="container">
            <div class="section-title" data-aos="fade-left">
                ...
                @elseif ($togglePage)
                <h2>Create Kegiatan Pramuka</h2>
                @else
                <h2>Kegiatan Pramuka</h2>
                @endif                
                ...
                @if ($id_blog)
                {{-- <h1>UPDATE</h1> --}}
                <form method="POST" action="/kesiswaan/kegPramuka/{{ $id_blog }}" class="php-email-form" wire:ignore>
                    @method('patch')
                    @else
                    {{-- <h1>CREATE</h1> --}}
                    <form method="POST" action="/kesiswaan/kegPramuka" class="php-email-form" wire:ignore>
                        @endif
                        @csrf
                        <div class="form-group">
                            <input type="hidden" name="tag" value="kegiatan_pramuka" required />
                            <input type="hidden" name="title" value="Kegiatan Pramuka" required />
                        </div>
                        <div class="form-group">
