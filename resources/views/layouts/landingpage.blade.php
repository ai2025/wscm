    ...
    <body class="font-sans antialiased">
        ...
        <footer id="footer">
            ...
            <div class="footer-top">
                <div class="container">
                    <div class="row">
                        ...
                        <h3>nama belum tersedia</h3>
                        <p>
                            alamat belum tersedia <br>
                            kabupaten belum tersedia<br>
                            provinsi belum tersedia, pos belum tersedia, negara belum tersedia <br><br>
                                <strong>Phone:</strong> belum tersedia<br>
                                <strong>Email:</strong> belum tersedia<br>
                            </p>
            ...
            <div class="container d-md-flex py-4">
                ...
                <div class="mr-md-auto text-center text-md-left">
                    <div class="copyright">
                        &copy; Copyright <strong><span>Aisyatush S. & Reza U. A.</span></strong>. All Rights Reserved                        
                    </div>
                    <div class="credits">
                        <!-- All the links in the footer should remain intact. -->
                        <!-- You can delete the links only if you purchased the pro version. -->
